...
import 'package:tracker/features/purchased/page/purchase_order_page.dart';
...
/// Consistent empty state for the purchased list.
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.local_mall_outlined, size: 44, color: AppColors.warmGray),
          ...
          Text(
            'Recorded purchases will appear here.',
